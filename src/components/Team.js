          ...
          <Row>
            <Col xs={12} lg={3}>
              <div className="card text-center" style={{ marginTop: "50px" }}>
                ...
                <div className="card-body text-dark">
                  <h4 className="card-title">Sutanto Adi</h4>
                  <h6>Back End Developer</h6>
                  <p className="card-text text-secondary">
                    As a Front End Developer, he's so smart and attractive. He
                    says, the programming is his wife and really love his wife.
                    And he also always excited to learn all about his wife. For
                    him, the error is his son.
                  </p>
                  <a
            ...
            <Col xs={12} lg={3}>
              <div className="card text-center" style={{ marginTop: "50px" }}>
                ...
                <div className="card-body text-dark">
                  <h4 className="card-title">Rizkian Akbar</h4>
                  <h6>Front End Developer</h6>
                  <p className="card-text text-secondary">
                    He's very smart. He always wants to know everything related
                    to programming, that is the reason why he can become a full
                    stack developer and have too much experience about
                    programming.
                  </p>
                  <a
              ...
              <div className="card text-center" style={{ marginTop: "50px" }}>
                ...
                <div className="card-body text-dark">
                  ...
                  <p className="card-text text-secondary">
                    ...
                    likes something that looks difficult, maybe that's the
                    reason why he is a back end developer now.
                  </p>
                  <a
            ...
            <Col xs={12} lg={3}>
              <div className="card text-center" style={{ marginTop: "50px" }}>
                ...
                <div className="card-body text-dark">
                  <h4 className="card-title">Mega Iriantika</h4>
                  <h6>UI / UX Designer</h6>
                  <p className="card-text text-secondary">
                    She is an ordinary girl but a little different from most
                    girls. She spent his time to learning about UI / UX, and now
                    she has become a reliable UI / UX Designer.
                  </p>
                  <a
